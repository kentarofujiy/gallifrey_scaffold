...
require_relative File.expand_path("../../lib/generators/gallifrey_scaffold_generator", __FILE__)

ENV["RAILS_ENV"] = 'test'

class ScaffoldGeneratorTest < ::Rails::Generators::TestCase

  tests GallifreyScaffoldGenerator
  ...
  test "generates js css" do
    ...
    assert_file "app/assets/javascripts/gallifrey_scaffold.js"
    assert_file "app/assets/javascripts/bootstrap-colorpicker.js"
    assert_file "app/assets/javascripts/bootstrap-datetimepicker-for-gallifrey-scaffold.js"
