...
Fully customizable.
Info : https://github.com/rivsc/Gallifrey-Scaffold
Demo : http://demo.gallifrey-scaffold.escarworld.com/
...
Add this in your Gemfile :
    ...
    gem 'gallifrey_scaffold', '0.3.4'

=== RubyOnRails 4.2

Add this in your Gemfile :

    gem 'gallifrey_scaffold', '0.3.5'

=== RubyOnRails 5+

Add this in your Gemfile :

    gem 'gallifrey_scaffold', '1.0.1'
